...
public class MiniJavaGrammarAccess extends AbstractGrammarElementFinder {
	...
	public class InterfaceElements extends AbstractParserRuleElementFinder {
		...
		//Interface:
		//	accessLevel=AccessLevel? 'interface' name=ID ('extends' implements+=[Interface|QualifiedName] (','
		//	implements+=[Interface|QualifiedName])*)? '{'
		//	members+=Member*
		//	'}';
		@Override public ParserRule getRule() { return rule; }
		...
		//accessLevel=AccessLevel? 'interface' name=ID ('extends' implements+=[Interface|QualifiedName] (','
		//implements+=[Interface|QualifiedName])*)? '{' members+=Member* '}'
		public Group getGroup() { return cGroup; }
	...
	public class MethodElements extends AbstractParserRuleElementFinder {
		...
		//access=AccessLevel? abstract?='abstract'? static?='static'? typeRef=TypeRef name=ID? '(' (params+=Parameter (','
