 ...
 * </p>
 * <ul>
 *   <li>{@link org.tetrabox.minijava.dynamic.minijavadynamicdata.impl.DoubleValueImpl#getValue <em>Value</em>}</li>
 * </ul>
 *
 * @generated
 */
public class DoubleValueImpl extends ValueImpl implements DoubleValue {
	...
	protected EClass eStaticClass() {
		return MinijavadynamicdataPackage.Literals.DOUBLE_VALUE;
	}
	...
	public void setValue(double newValue) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, MinijavadynamicdataPackage.DOUBLE_VALUE__VALUE, oldValue, value));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case MinijavadynamicdataPackage.DOUBLE_VALUE__VALUE:
				return getValue();
		}
