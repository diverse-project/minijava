 ...
 * </p>
 * <ul>
 *   <li>{@link org.tetrabox.minijava.dynamic.minijavadynamicdata.impl.FloatValueImpl#getValue <em>Value</em>}</li>
 * </ul>
 *
 * @generated
 */
public class FloatValueImpl extends ValueImpl implements FloatValue {
	...
	protected EClass eStaticClass() {
		return MinijavadynamicdataPackage.Literals.FLOAT_VALUE;
	}
	...
	public void setValue(float newValue) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, MinijavadynamicdataPackage.FLOAT_VALUE__VALUE, oldValue, value));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case MinijavadynamicdataPackage.FLOAT_VALUE__VALUE:
				return getValue();
		}
