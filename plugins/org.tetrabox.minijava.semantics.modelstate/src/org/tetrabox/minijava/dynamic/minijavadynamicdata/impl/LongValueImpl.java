 ...
 * </p>
 * <ul>
 *   <li>{@link org.tetrabox.minijava.dynamic.minijavadynamicdata.impl.LongValueImpl#getValue <em>Value</em>}</li>
 * </ul>
 *
 * @generated
 */
public class LongValueImpl extends ValueImpl implements LongValue {
	...
	protected EClass eStaticClass() {
		return MinijavadynamicdataPackage.Literals.LONG_VALUE;
	}
	...
	public void setValue(long newValue) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, MinijavadynamicdataPackage.LONG_VALUE__VALUE, oldValue, value));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case MinijavadynamicdataPackage.LONG_VALUE__VALUE:
				return getValue();
		}
