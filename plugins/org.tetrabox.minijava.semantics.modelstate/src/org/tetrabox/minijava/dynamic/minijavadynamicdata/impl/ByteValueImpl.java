 ...
 * </p>
 * <ul>
 *   <li>{@link org.tetrabox.minijava.dynamic.minijavadynamicdata.impl.ByteValueImpl#getValue <em>Value</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ByteValueImpl extends ValueImpl implements ByteValue {
	...
	protected EClass eStaticClass() {
		return MinijavadynamicdataPackage.Literals.BYTE_VALUE;
	}
	...
	public void setValue(byte newValue) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, MinijavadynamicdataPackage.BYTE_VALUE__VALUE, oldValue, value));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case MinijavadynamicdataPackage.BYTE_VALUE__VALUE:
				return getValue();
		}
