 ...
 * </p>
 * <ul>
 *   <li>{@link org.tetrabox.minijava.dynamic.minijavadynamicdata.impl.ShortValueImpl#getValue <em>Value</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ShortValueImpl extends ValueImpl implements ShortValue {
	...
	protected EClass eStaticClass() {
		return MinijavadynamicdataPackage.Literals.SHORT_VALUE;
	}
	...
	public void setValue(short newValue) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, MinijavadynamicdataPackage.SHORT_VALUE__VALUE, oldValue, value));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case MinijavadynamicdataPackage.SHORT_VALUE__VALUE:
				return getValue();
		}
