 ...
 * </p>
 * <ul>
 *   <li>{@link org.tetrabox.minijava.xminijava.miniJava.impl.MethodImpl#isAbstract <em>Abstract</em>}</li>
 *   <li>{@link org.tetrabox.minijava.xminijava.miniJava.impl.MethodImpl#isStatic <em>Static</em>}</li>
 *   <li>{@link org.tetrabox.minijava.xminijava.miniJava.impl.MethodImpl#getParams <em>Params</em>}</li>
 *   <li>{@link org.tetrabox.minijava.xminijava.miniJava.impl.MethodImpl#getBody <em>Body</em>}</li>
 * </ul>
 *
 * @generated
 */
public class MethodImpl extends MemberImpl implements Method {
	...
	public void setAbstract(boolean newAbstract) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, MiniJavaPackage.METHOD__ABSTRACT, oldAbstract, abstract_));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case MiniJavaPackage.METHOD__ABSTRACT:
				return isAbstract();
