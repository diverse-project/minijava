 ...
 * </p>
 * <ul>
 *   <li>{@link org.tetrabox.minijava.xminijava.miniJava.impl.TypeDeclarationImpl#getAccessLevel <em>Access Level</em>}</li>
 *   <li>{@link org.tetrabox.minijava.xminijava.miniJava.impl.TypeDeclarationImpl#getImplements <em>Implements</em>}</li>
 *   <li>{@link org.tetrabox.minijava.xminijava.miniJava.impl.TypeDeclarationImpl#getMembers <em>Members</em>}</li>
 * </ul>
 *
 * @generated
 */
public class TypeDeclarationImpl extends NamedElementImpl implements TypeDeclaration {
	...
	public EList<Interface> getImplements() {
		if (implements_ == null) {
			implements_ = new EObjectResolvingEList<Interface>(Interface.class, this, MiniJavaPackage.TYPE_DECLARATION__IMPLEMENTS);
		}
		return implements_;
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			...
			case MiniJavaPackage.TYPE_DECLARATION__IMPLEMENTS:
